...
def q_i_j_connectivity(DFC, simplex1, simplex2):
    ...
    Notes
    -----
    This algorithm is based on concept of
    (q,i,j)-connectivity as introduced in [1].

    References
    ----------
    [1]  Riihimäki, H. (2021). Simplicial q-connectivity of directed graphs
    with applications to network analysis. ArXiv:2202.07307.
    '''
    k1 = len(simplex1)-2
    k2 = len(simplex2)-2
